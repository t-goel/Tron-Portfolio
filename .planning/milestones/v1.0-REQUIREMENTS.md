...
- [x] **PROJ-01**: Camera lerps through selected Projects pane as fly-through transition into sector
- [x] **PROJ-02**: Three 3D rectangular monoliths rise from grid floor, each displaying project name, one-line tagline, and tech stack tags; glowing emissive edges in assigned accent color
- [x] **PROJ-03**: Active project monolith (active: true) uses Crimson Red accent and displays "IN PROGRESS" tag; all others use Neon Orange
- [x] **PROJ-04**: Hover on monolith triggers slow vertical bob/float animation with brightening emissive glow
- [x] **PROJ-05**: Click on monolith opens project's GitHub URL in new tab
- [x] **PROJ-06**: All monolith content driven from src/data/projects.js — no project data hardcoded in components

### About Me Sector (Phase 5b)

- [x] **ABOUT-01**: Camera flies into About pane, pane expands to fill full viewport (100vw × 100vh)
- [x] **ABOUT-02**: 3D background scene receives heavy Gaussian blur behind the 2D overlay
- [x] **ABOUT-03**: 2D terminal interface auto-types bio content as bash commands: whoami, cat background.txt, cat interests.txt, cat looking_for.txt, ls contact/, cat contact/*
- [x] **ABOUT-04**: Contact links (GitHub, LinkedIn, email) render as clickable glowing terminal links at end of typewriter output

### Skills Sector (Phase 5c)

- [x] **SKILLS-01**: Camera flies into Skills pane, pane expands to fill full viewport (100vw × 100vh) with heavy background blur
- [x] **SKILLS-02**: HTML Canvas 2D network graph renders full-viewport — Tier 1 category nodes (5 categories) visible and labeled, connected by faint glowing lines
- [x] **SKILLS-03**: Click on Tier 1 category node triggers light-racer expansion: cyan trails shoot outward and spawn Tier 2 skill nodes at endpoints with connecting lines
- [x] **SKILLS-04**: Clicking same category node again collapses Tier 2 nodes — they retract along trails and disappear
- [x] **SKILLS-05**: Hover on any node highlights it and all connected edges with brightness pulse, displays label if not visible
...
- [x] **NFR-02**: Mobile graceful degradation (<768px): boot sequence scales to fit, OrbitControls disabled, gateway panes stacked vertically in scrollable 2D overlay, simplified static grid loops in background
...
- [x] **NFR-04**: Open Graph meta tags — OG title "Tanmay Goel — Software Developer", OG description, OG image matching Phase 2 visual on black background
- [x] **NFR-05**: Favicon is a glowing Crimson Red "T" in TR2N font on black background
...
| PROJ-01 | Phase 4 — Sector Dives + Finish | Complete |
| PROJ-02 | Phase 4 — Sector Dives + Finish | Complete |
| PROJ-03 | Phase 4 — Sector Dives + Finish | Complete |
| PROJ-04 | Phase 4 — Sector Dives + Finish | Complete |
| PROJ-05 | Phase 4 — Sector Dives + Finish | Complete |
| PROJ-06 | Phase 4 — Sector Dives + Finish | Complete |
| ABOUT-01 | Phase 4 — Sector Dives + Finish | Complete |
| ABOUT-02 | Phase 4 — Sector Dives + Finish | Complete |
| ABOUT-03 | Phase 4 — Sector Dives + Finish | Complete |
| ABOUT-04 | Phase 4 — Sector Dives + Finish | Complete |
| SKILLS-01 | Phase 4 — Sector Dives + Finish | Complete |
| SKILLS-02 | Phase 4 — Sector Dives + Finish | Complete |
| SKILLS-03 | Phase 4 — Sector Dives + Finish | Complete |
| SKILLS-04 | Phase 4 — Sector Dives + Finish | Complete |
| SKILLS-05 | Phase 4 — Sector Dives + Finish | Complete |
| NFR-02 | Phase 4 — Sector Dives + Finish | Complete |
| NFR-04 | Phase 4 — Sector Dives + Finish | Complete |
| NFR-05 | Phase 4 — Sector Dives + Finish | Complete |
